...
public enum TransactionResult {
    ...
    InvalidSaleId("The order identification could not be found."),
    ...
    NoSalesRegistered("No orders on record for the user"),
    ProblemProcessingAnOrder("We had some problems processing this order."),
